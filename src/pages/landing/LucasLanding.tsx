...
export default function LucasLanding() {
  useUtmTracking();
  ...
  const description =
    "Precision meets style in every cut. I specialize in creating fresh, modern looks that enhance your natural features and boost your confidence.";

  return (
    <LandingLayout>
      <Helmet>
        <title>Lucas Fadelines BEST BARBER/HAIRDRESSER IN MELBOURNE</title>
        <meta
          name="description"
          content={`Lucas Fadelines BEST BARBER IN MELBOURNE - ${description}`}
        />
        <meta
          property="og:title"
          content="Lucas Fadelines BEST BARBER IN MELBOURNE"
        />
        <meta
      ...
      <div className="flex flex-col bg-stone-950 w-full h-full relative">
        ...
        <section className="relative w-full h-[35rem] md:h-[35rem] ">
          <div className="absolute z-0 w-full h-[40rem] md:h-[35rem] object-cover bg-[url(/lucas-bg.png)] bg-center bg-cover"></div>
